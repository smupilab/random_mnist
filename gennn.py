...
output.write("    log.write('Epoch: {:04d}, Cost: {:.9f}, Acc: {:.4f}'.format(epoch + 1, cost_sum, total_acc/num_batch))\n")
output.write("\n")
output.write("print('Learning finished')\n")
output.write("acc = Accuracy(x_test, y_test)\n")
output.write("print('Accuracy = {:.4f}'.format(acc))\n")
output.write("log.write('Accuracy = {:.4f}'.format(acc))\n")
